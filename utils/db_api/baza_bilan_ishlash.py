...
class Database:
    ...
    def add_to_korzinka(self, ism: str,tg_id:int,nomi:str, rasm:str,son:int):
        sql = """
           INSERT INTO myfiles_korzinka(ism,tg_id,nomi,rasm,son) VALUES(?, ?, ?, ?, ?)
           """
        self.execute(sql, parameters=(ism,tg_id,nomi,rasm,son), commit=True)
    ...
    def select_from_menu(self, **kwargs):
